...
public class WebServletConfiguration implements WebApplicationInitializer {
	...
	public void onStartup(ServletContext servletContext) {
		...
		// Create the 'root' Spring application context
	      ...
	      rootContext.register(WebMvcConfig.class,RootContext.class);
	      ...
	      FilterRegistration.Dynamic crosFilter = servletContext.addFilter("CorsFilter", new CorsFilter());
			...
			crosFilter.setInitParameter("cors.allowed.headers", "Authorization,Content-Type,X-Requested-With,accept,Origin,Access-Control-Request-Method,Access-Control-Request-Headers,access-control-expose-headers, Content-Disposition,content-Disposition,Content-Type,content-Type, Date, userId, message ");
