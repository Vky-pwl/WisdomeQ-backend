...
public interface GenericDao<T, PK extends Serializable> {
	...
	List<T> listEntityByParameter(String queryStatment, Map<String, Object> paramsKayAndValues, Integer start,
			Integer maxRows);

	Object singleRowResult(String sqlQuery, Map<String, Object> paramsKayAndValues);

	T findEntityByParameter(String queryStatment, Map<String, Object> paramsKayAndValues);

	void updateBySqlQuery(String sqlQuery, Map<String, Object> paramsKayAndValues);
